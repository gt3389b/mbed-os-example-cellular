/*!
 * @file
 * @brief Interface for WNCM14A2A core functionality.
 *
 ...
 *  Implementation of the NetworkStack for the WNC14A2A GSM Modem
 */
class WNC14A2AInterface : public NetworkStack, public CellularInterface {
public:
    /** WNC14A2AInterface lifetime
     * @param tx        TX pin
     * @param rx        RX pin
     ...
     */
    WNC14A2AInterface(PinName tx, PinName rx, PinName rstPin, PinName pwrPin, bool debug);

    /**
    * Startup the WNC14A2A
    *
    * @return true only if WNC14A2A was started correctly
    */
    bool powerUpModem();
    ...
    * Reset WNC14A2A
    *
    * @return true only if WNC14A2A resets successfully
    ...
    *
    * @return true only if WNC14A2A OK's to AT cmd
    */
    bool isModemAlive();
...
private:
    WNCATParser _wnc;
    bool _sockets[WNC_SOCKET_COUNT];
